...
import { Edit, Trash2, Crown, Bot } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          ...
          >
            <div>
              ...
              <p className="mt-3 text-muted-foreground max-w-prose text-lg">Train, customize, and evolve your roster. Pick one to battle or create a new champion.</p>
            </div>
            <div className="hidden sm:flex gap-2">
              <Button asChild size="lg"><Link href="/onboarding"><Plus className="mr-2 size-4" />Create Agent</Link></Button>
              <Button asChild variant="secondary" size="lg"><Link href="/arena">Browse Arenas</Link></Button>
            </div>
          </motion.div>
          ...
          {created && (
            <motion.div
              ...
              className="mt-6 rounded-md border border-border bg-secondary/50 px-4 py-3 text-sm mb-8"
            >
